 ...
 * 
 * @export
 * @interface InsuranceTokenBalance
 */
export interface InsuranceTokenBalance {
    /**
     * Token contract address
     * @type {string}
     * @memberof InsuranceTokenBalance
     */
    address: string;
    /**
     * Token symbol
...
export function InsuranceTokenBalanceFromJSON(json: any): InsuranceTokenBalance {
    return InsuranceTokenBalanceFromJSONTyped(json, false);
}

export function InsuranceTokenBalanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): InsuranceTokenBalance {
...
export function InsuranceTokenBalanceToJSON(value?: InsuranceTokenBalance | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
