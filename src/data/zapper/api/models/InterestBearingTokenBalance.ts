 ...
 * 
 * @export
 * @interface InterestBearingTokenBalance
 */
export interface InterestBearingTokenBalance {
    /**
     * Token contract address
     * @type {string}
     * @memberof InterestBearingTokenBalance
     */
    address: string;
    /**
     * Token symbol
...
export function InterestBearingTokenBalanceFromJSON(json: any): InterestBearingTokenBalance {
    return InterestBearingTokenBalanceFromJSONTyped(json, false);
}

export function InterestBearingTokenBalanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): InterestBearingTokenBalance {
...
export function InterestBearingTokenBalanceToJSON(value?: InterestBearingTokenBalance | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
