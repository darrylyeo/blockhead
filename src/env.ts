export const env = {
    ...
    QUICKNODE_ENDPOINT_NAME_100: String(import.meta.env.VITE_QUICKNODE_ENDPOINT_NAME_100 || ''),
    QUICKNODE_ENDPOINT_AUTHENTICATION_TOKEN_100: String(import.meta.env.VITE_QUICKNODE_ENDPOINT_AUTHENTICATION_TOKEN_100 || ''),
