...
export const env = {
	...
	FIREBLOCKS_SANDBOX_NCW_SIGNER_API_KEY: publicEnv.PUBLIC_FIREBLOCKS_SANDBOX_NCW_SIGNER_API_KEY || '',
	...
	FIREBLOCKS_PRODUCTION_NCW_SIGNER_API_KEY: publicEnv.PUBLIC_FIREBLOCKS_PRODUCTION_NCW_SIGNER_API_KEY || '',
