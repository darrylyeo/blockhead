	...
	export namespace Accounts {
		...
		export const getTransactions = async ({
			...
			searchParams: {
				...
				action: 'txlist',
				address,
				...(startBlock !== undefined && { startblock: Number(startBlock) }),
				...(endBlock !== undefined && { endblock: Number(endBlock) }),
				page,
				offset,
				sort,
			},
		...
		export const getTransactionsInternal = async ({
			...
			searchParams: {
				...
				address,
				startblock: startBlock !== undefined ? Number(startBlock) : undefined,
				endblock: endBlock !== undefined ? Number(endBlock) : undefined,
				page,
				offset,
				sort,
			},
