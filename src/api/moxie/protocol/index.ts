/**
 * Moxie Protocol GraphQL API
 * @link https://developer.moxie.xyz/api/protocol/overview
 */
...
export const graphqlEndpoints = [
	{
		label: 'Base',
		chainId: 8453,
		endpoint: 'https://api.studio.thegraph.com/query/23537/moxie_protocol_stats_mainnet/version/latest',
	},
] as const satisfies {
	label: string,
	chainId: number,
