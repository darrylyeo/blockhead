/**
 * Moxie Vesting GraphQL API
 * @link https://developer.moxie.xyz/api/vesting/overview
 */
...
export const graphqlEndpoints = [
	{
		label: 'Base',
		chainId: 8453,
		endpoint: 'https://api.studio.thegraph.com/query/23537/moxie_vesting_mainnet/version/latest',
	},
] as const satisfies {
	label: string,
	chainId: number,
