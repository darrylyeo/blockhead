...
export interface paths {
    ...
    "/invites": {
        ...
        /**
         * List invites
         * @description Returns all the user invites.
         */
    ...
    "/chains/{chain}/addresses/{address-or-alias}": {
        parameters: {
            ...
            path: {
                ...
                "address-or-alias": components["parameters"]["AddressOrAlias"];
            };
            cookie?: never;
        };
        /**
    ...
    "/plan": {
        ...
        /**
         * Get plan
         * @description Returns the current plan with limits and features.
         */
...
export interface components {
    schemas: {
         ...
         */
        Address: components["schemas"]["AddressAlias"] & {
            balance?: string;
            chain: string;
            /**
             * Format: int64
        ...
        ContractInformation: {
            address: components["schemas"]["ETHAddress"];
            addressAlias: components["schemas"]["Alias"];
        ...
        HSMSignRequestPersonalSign: {
            /**
             * @description The signing method to use. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
        ...
        HSMSignRequestTypedData: {
            ...
            address: components["schemas"]["ETHAddress"];
            data: components["schemas"]["EIP712TypedData"];
        };
        HSMSignRequest: components["schemas"]["HSMSignRequestPersonalSign"] | components["schemas"]["HSMSignRequestTypedData"];
        /**
         * HSMSignResponse
        ...
        /**
         * Plan
         * @description A plan containing limits and features.
         */
        Plan: {
            ...
            updatedAt: string;
            /** @description The limits associated with the plan. */
            limits: components["schemas"]["PlanLimit"][];
            /** @description The features associated with the plan. */
            features: components["schemas"]["PlanFeature"][];
        };
        /**
         * Limit
         * @description A limit on plan usage.
         */
        PlanLimit: {
            /**
             ...
             * @enum {unknown}
             */
            name: "api_calls_per_sec" | "api_calls_per_day" | "api_calls_per_month" | "events_per_sec" | "users" | "contracts" | "linked_contracts" | "event_query_max_results" | "event_logging_retention_hours" | "past_logs_max_concurrency" | "past_logs_max_depth" | "cloud_wallets";
            /**
             * Format: int64
             * @description The limit value. Null means unlimited.
             */
            limit: number | null;
            /**
             * Format: int64
             * @description The current count for this limit.
             */
            count?: number;
        };
        /**
         * Feature
         * @description A feature flag in a plan.
         */
        PlanFeature: {
            /**
             ...
             * @enum {unknown}
             */
            name: "event_logging_feature" | "event_monitor_feature" | "event_queries_feature" | "faucet_feature" | "historical_blocks_feature" | "hsm_feature";
        ...
        PostMethodArgs: {
            ...
            args?: unknown[];
            from?: components["schemas"]["AddressOrAlias"];
            /**
             * Format: int64
             ...
             */
            gas?: number;
            to?: components["schemas"]["AddressOrAlias"];
             ...
             */
            preEIP1559: boolean;
            signer?: components["schemas"]["AddressOrAlias"];
            /**
        ...
        Transaction: {
            ...
            chainId?: components["schemas"]["HexOrNull"];
            nonce: components["schemas"]["Hex"];
            to: components["schemas"]["ETHAddressOrNull"];
            from?: components["schemas"]["ETHAddressOrNull"];
            ...
            maxFeePerBlobGas?: components["schemas"]["HexOrNull"];
            value: components["schemas"]["HexOrNull"];
            input: components["schemas"]["Hex"];
            accessList?: components["schemas"]["AccessTuple"][] | null;
            blobVersionedHashes?: components["schemas"]["Keccak256Hash"][] | null;
            authorizationList?: components["schemas"]["SetCodeAuthorization"][] | null;
            v: components["schemas"]["Hex"];
            r: components["schemas"]["Hex"];
            s: components["schemas"]["Hex"];
            yParity?: components["schemas"]["HexOrNull"];
            blobs?: components["schemas"]["Blob"][] | null;
            commitments?: components["schemas"]["Commitment"][] | null;
            proofs?: components["schemas"]["Proof"][] | null;
            hash: components["schemas"]["Keccak256Hash"];
        };
        /**
        ...
        SetCodeAuthorization: {
            ...
            address: components["schemas"]["ETHAddress"];
            nonce: components["schemas"]["Hex"];
            yParity: components["schemas"]["Hex"];
            r: components["schemas"]["Hex"];
            s: components["schemas"]["Hex"];
        };
        /**
         * AuthorizationExtraInfo
         * @description Additional information about any EIP-7702 authorizations.
         */
        AuthorizationExtraInfo: {
            authority: components["schemas"]["ETHAddress"];
            /** @description Indicates whether the format of the authorization is valid. */
            formatValid: boolean;
            /** @description Additional notes about the validity of the authorization. */
            notes: string;
        };
        /**
         * AccessTuple
         ...
         */
        AccessTuple: {
            address: components["schemas"]["ETHAddressOrNull"];
            storageKeys: components["schemas"]["Keccak256Hash"][];
        };
        /**
         * Blob
        ...
        TransactionData: {
            ...
            authorizationExtraInfo?: components["schemas"]["AuthorizationExtraInfo"][] | null;
        };
        /**
         ...
         * @enum {string}
         */
        FieldType: "input" | "contract_label" | "contract_name" | "contract_address" | "contract_address_alias" | "block_number" | "triggered_at" | "event_signature" | "block_hash" | "tx_hash" | "tx_from";
        /**
         * EventQueryField
        ...
        /**
         * AddressOrAlias
         * @description An Ethereum address (0x prefixed hex) or an address alias.
         */
        ...
        /**
         * InviteRequest
         * @description An invite request with groups.
         */
        InviteRequest: {
            /**
             * Format: email
        ...
        /**
         * Invite
         * @description A user invitation to MultiBaas.
         */
        Invite: {
            /**
             * Format: email
            ...
            /**
             * Format: date-time
             * @description The time the invite expires.
             */
            expiresAt: string;
        };
        /**
        ...
        EIP712Types: {
            EIP712Domain: components["schemas"]["EIP712TypeEntry"][];
        } & {
        ...
        EIP712Domain: {
            ...
            chainId?: number | components["schemas"]["Hex"];
            verifyingContract?: components["schemas"]["ETHAddress"];
            salt?: components["schemas"]["Hex"];
        };
    ...
    parameters: {
        /** @description An address or the alias of an address. */
        AddressOrAlias: components["schemas"]["AddressOrAlias"];
        /** @description A block number, hash or 'latest' for the latest block. */
        BlockRef: string;
        /** @description The blockchain chain label. */
...
export interface operations {
    ...
    "list-invites": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["BaseResponse"] & {
                        result: components["schemas"]["Invite"][];
                    };
                };
            };
            "4XX": components["responses"]["ClientError"];
    ...
    "list-addresses": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["BaseResponse"] & {
                        result: components["schemas"]["AddressAlias"][];
                    };
                };
            };
            "4XX": components["responses"]["ClientError"];
    ...
    "set-address": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AddressAlias"];
            };
        };
        responses: {
            /** @description OK */
    ...
    "call-contract-function": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["BaseResponse"] & {
                        result: components["schemas"]["TransactionToSignResponse"] | components["schemas"]["MethodCallResponse"];
                    };
                };
            };
            "4XX": components["responses"]["ClientError"];
    ...
    "sign-and-submit-transaction": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CloudWalletTXToSign"];
            };
        };
        responses: {
            /** @description OK */
