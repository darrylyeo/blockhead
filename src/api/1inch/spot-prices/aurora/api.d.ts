...
export interface paths {
    "/v1.1/1313161554": {
         ...
         */
        get: operations["ChainController_whitelist_v1.1"];
        put?: never;
        /**
         * Prices for requested tokens
         * @description Returns prices for requested tokens
         */
        post: operations["ChainController_byAddressesPost_v1.1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1.1/1313161554/currencies": {
         ...
         */
        get: operations["ChainController_getCustomCurrencies_v1.1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1.1/1313161554/{addresses}": {
         ...
         * @description Returns prices for requested tokens
         */
        get: operations["ChainController_byAddresses_v1.1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    "ChainController_whitelist_v1.1": {
        parameters: {
            query?: {
                /** @description If no currency provided, then price returned in native Wei */
    ...
    "ChainController_byAddressesPost_v1.1": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "ChainController_getCustomCurrencies_v1.1": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "ChainController_byAddresses_v1.1": {
        parameters: {
            query?: {
                /** @description If no currency provided, then price returned in native Wei */
                currency?: "USD" | "AED" | "ARS" | "AUD" | "BDT" | "BHD" | "BMD" | "BRL" | "CAD" | "CHF" | "CLP" | "CNY" | "CZK" | "DKK" | "EUR" | "GBP" | "HKD" | "HUF" | "IDR" | "ILS" | "INR" | "JPY" | "KRW" | "KWD" | "LKR" | "MMK" | "MXN" | "MYR" | "NGN" | "NOK" | "NZD" | "PHP" | "PKR" | "PLN" | "RUB" | "SAR" | "SEK" | "SGD" | "THB" | "TRY" | "TWD" | "UAH" | "VEF" | "VND" | "ZAR";
