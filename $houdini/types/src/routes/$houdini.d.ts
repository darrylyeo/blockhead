...
type LayoutRouteId = RouteId | "/" | "/apps" | "/apps/[web3AppSlug=isWeb3AppSlug]" | "/apps/[web3AppSlug=isWeb3AppSlug]/account/[accountId]" | "/apps/[web3AppSlug=isWeb3AppSlug]/address/[accountId]" | "/apps/audius" | "/apps/audius/playlist/[audiusPlaylistId]" | "/apps/audius/search/[audiusQuery]" | "/apps/audius/track/[audiusTrackId]" | "/apps/audius/user/[audiusUserId]" | "/apps/ens/account/[accountId]" | "/apps/ipfs" | "/apps/ipfs/content/[ipfsContentId]" | "/apps/ipfs/content/[ipfsContentId]/[...ipfsContentPath]" | "/apps/lens" | "/apps/lens/account/[accountId]" | "/explorer" | "/explorer/[networkSlug=isNetworkSlugRedirect]" | "/explorer/[networkSlug=isNetworkSlugRedirect]/[...params]" | "/explorer/[networkSlug=isNetworkSlug]" | "/explorer/[networkSlug=isNetworkSlug]/[query=isBlockNumber]" | "/explorer/[networkSlug=isNetworkSlug]/[query=isEnsName]" | "/explorer/[networkSlug=isNetworkSlug]/[query=isEthereumAddress]" | "/explorer/[networkSlug=isNetworkSlug]/[query=isEthereumTransaction]" | "/explorer/bitcoin" | "/explorer/bitcoin/[query]" | "/portfolio" | "/transfer" | null
type LayoutParams = RouteParams & { web3AppSlug?: string,accountId?: string,audiusPlaylistId?: string,audiusQuery?: string,audiusTrackId?: string,audiusUserId?: string,ipfsContentId?: string,ipfsContentPath?: string,networkSlug?: string,params?: string,query?: string }
