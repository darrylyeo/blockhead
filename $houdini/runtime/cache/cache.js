...
export class Cache {
        ...
        for (const { type, keyRaw, fields, list, filters } of Object.values(selection)) {
            ...
            if (!isScalar(this._config, type)) {
                ...
                if (list && fields) {
                    ...
                    (_a = this._lists.get(list.name)) === null || _a === void 0 ? void 0 : _a.set(spec.parentID || rootID, new ListHandler({
                        name: list.name,
    ...
    extractNestedListIDs({ value, abstract, recordID, key, linkedType, fields, variables, applyUpdates, specs, }) {
        var _a;
    ...
    unsubscribeSelection(record, selection, variables, ...subscribers) {
        ...
        for (const { keyRaw, fields } of Object.values(selection)) {
            ...
            if (fields) {
                // figure out who else needs subscribers
                const children = record.flatLinkedList(key).length > 0
